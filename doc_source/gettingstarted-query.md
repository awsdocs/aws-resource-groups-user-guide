...
After you have created a resource group, you can use the group to [view insights about](viewing-group-insights.md) or perform tasks on the resources in the group\.
