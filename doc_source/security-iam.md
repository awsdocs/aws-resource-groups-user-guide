# Identity and access management for AWS Resource Groups<a name="security-iam"></a>
...
### AWS account root user<a name="security_iam_authentication-rootuser-arg-te"></a>
...
### IAM users and groups<a name="security_iam_authentication-iamuser-arg-te"></a>
...
### IAM roles<a name="security_iam_authentication-iamrole-arg-te"></a>
...
## Managing access using policies<a name="security_iam_access-manage-arg-te"></a>
...
### Identity\-based policies<a name="security_iam_access-manage-id-based-policies-arg-te"></a>
...
### Resource\-based policies<a name="security_iam_access-manage-resource-based-policies-arg-te"></a>
...
### Access control lists \(ACLs\)<a name="security_iam_access-manage-acl-arg-te"></a>
...
### Other policy types<a name="security_iam_access-manage-other-policies-arg-te"></a>
...
### Multiple policy types<a name="security_iam_access-manage-multiple-policies-arg-te"></a>
